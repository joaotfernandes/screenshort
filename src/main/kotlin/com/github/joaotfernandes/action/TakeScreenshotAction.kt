...
import com.github.joaotfernandes.ScreenshortIcons
...
class TakeScreenshotAction : AnAction(ScreenshortIcons.SCREENSHOT_ICON) {
    ...
    companion object {
        ...
        private val DST_FILE_NAME_FORMAT = "%s/device-%s.%s"
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            device?.screenshot?.toFile(SCREENSHOT_IMAGE_FORMAT, BufferedImage.TYPE_INT_ARGB, getDstFile(project))
        }
    }
